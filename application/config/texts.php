...
return array(
	...
	"FEEDBACK_VIDEO_CREATION_FAILED" => "Video creation failed, please check the Youtube url!",
	"FEEDBACK_VIDEO_URL_CREATION_FAILED" => "The Youtube url code is invalid.",
	"FEEDBACK_TITLE_CREATION_FAILED" => "Faild to create Title.",
	"FEEDBACK_VIDEO_DELETION_FAILED" => "Faild to delete video.",
	"FEEDBACK_VIDEO_EDITING_FAILED" => "Video editing failed.",
